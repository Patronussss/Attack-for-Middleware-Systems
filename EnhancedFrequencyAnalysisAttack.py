...
def compute_feature_vector(matrix, select_column, dataset_name):
    ...
    "Race": ["American_Indian/Eskimo/Aleut","Asian_or_Pacific_Islander", 
        ...
        # 定义要统计取值范围的列
        specific_columns = ["Age",  "Risk", "Admission Type"]
    # 获取这些列的索引
...
if __name__ == '__main__':
    ...
    quarters = ['4q2010']
    out = 'result/single/output of FrequencyAnalysisAttack-our.txt'
    ...
    # filePathPlain = "dataset/2015.csv"
    # quarters = ['4q2010']
    # out = 'result/output of FrequencyAnalysisAttack-weight-300000.txt'
    # matrix_plain = functions.read_csv_to_matrix(filePathPlain)
