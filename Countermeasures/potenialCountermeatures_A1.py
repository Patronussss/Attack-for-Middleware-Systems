...
for i in base:
    ...
    for _ in range(50):
        ...
        mapping, totalTime, accuracy = AttackUsingAuxiliary(matrix_cipher_sse_after_mapping, matrix_plain, selected_columns_sse, "PUDF", max_time=300, recovery_threshold=0.95)
